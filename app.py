...
if prompt := st.chat_input("Ask me about information in the database..."):
    ...
    # Dynamically inject user's input into the system prompt
    system_prompt = prompt.format(prompt=prompt)
...
If the column is `STRING`, use `'Yes'` and `'No'` as is.
                            ...
                            7.Always double-check the syntax of your generated query for BigQuery compatibility
